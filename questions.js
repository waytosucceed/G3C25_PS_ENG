...
function loadQuestion(index) {
  ...
  imageElement.src = randomQuestion.image || "./assets/images/dummy-img.png";
  ...
  randomQuestion.options.forEach(function(option, idx) {
    ...
    // Create image element for options
    var img = document.createElement("img");
    img.src = randomQuestion.optionsImages ? randomQuestion.optionsImages[idx] : '';
    ...
    if (option.endsWith('.mp3')) {
     ...
     // Check if images for options are provided
     if (randomQuestion.optionsImages && randomQuestion.optionsImages[idx]) {
      var img = document.createElement("img");
      img.src = randomQuestion.optionsImages[idx];
      img.style.width = '100px';  // Set the desired width
      img.style.height = '100px'; // Set the desired height
...
//   var sound = new Audio('./assets/sounds/well-done.mp3'); // Update with the correct path to your sound file
//   sound.play();
